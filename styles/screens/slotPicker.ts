...
export const styles = StyleSheet.create({
  ...
  buildingCardActive: { borderColor: 'rgba(11,111,230,0.5)', backgroundColor: 'rgba(11,111,230,0.08)' },
  ...
  chipActive: { backgroundColor: 'rgba(11,111,230,0.15)', borderColor: 'rgba(11,111,230,0.4)' },
  ...
  floorCardActive: { borderColor: 'rgba(11,111,230,0.5)', backgroundColor: 'rgba(11,111,230,0.08)' },
  ...
  slotCell: { width: 64, height: 52, borderRadius: Radius.md, borderWidth: 1, borderColor: 'rgba(11,111,230,0.45)', backgroundColor: 'rgba(11,111,230,0.10)', alignItems: 'center', justifyContent: 'center', gap: 2 },
  slotCellSelected: { borderColor: Colors.primary, backgroundColor: 'rgba(11,111,230,0.25)' },
  ...
  feeHintBox: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(11,111,230,0.08)', borderRadius: Radius.md, borderWidth: 1, borderColor: 'rgba(11,111,230,0.2)', padding: Spacing.sm },
  feeHintText: { fontSize: FontSize.xs, color: Colors.primary, flex: 1 },
  modalBtns: { flexDirection: 'row', gap: Spacing.sm },
  openMapBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.primary, borderRadius: Radius.lg, paddingVertical: 14, gap: 8, borderWidth: 1, borderColor: 'rgba(11,111,230, 0.4)', shadowColor: Colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 4 },
  ...
  mapModalSheet: { backgroundColor: Colors.bg, borderTopLeftRadius: 28, borderTopRightRadius: 28, height: '90%', borderWidth: 1, borderBottomWidth: 0, borderColor: Colors.border, overflow: 'hidden' },
  mapModalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: Spacing.xl, paddingTop: Spacing.lg, paddingBottom: Spacing.md, borderBottomWidth: 1, borderBottomColor: Colors.border },
  ...
  mapToggleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: Spacing.sm, paddingHorizontal: Spacing.xl, paddingVertical: Spacing.md, backgroundColor: Colors.cardAlt, borderBottomWidth: 1, borderBottomColor: Colors.border },
  mapSelectHint: { fontSize: FontSize.xs, fontWeight: '700', color: Colors.textDim },
  mapModalContent: { flex: 1, minHeight: 0, backgroundColor: '#0b1220' },
  scroll2DContainer: { padding: Spacing.xl, alignItems: 'center', justifyContent: 'center' },
  mapModalFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: Spacing.md, paddingHorizontal: Spacing.xl, paddingVertical: Spacing.lg, backgroundColor: Colors.card, borderTopWidth: 1, borderTopColor: Colors.border },
  footerInfoCol: { gap: 4 },
  ...
  confirmSelectionBtn: { flexShrink: 0, backgroundColor: Colors.primary, borderRadius: Radius.lg, minHeight: 48, paddingHorizontal: 20, alignItems: 'center', justifyContent: 'center' },
  ...
  toggleBtnGroup: { flexDirection: 'row', backgroundColor: Colors.card, borderRadius: Radius.md, padding: 3, borderWidth: 1, borderColor: Colors.border },
  toggleBtn: { flexDirection: 'row', alignItems: 'center', minHeight: 32, paddingHorizontal: 8, borderRadius: Radius.sm, gap: 4 },
  toggleBtnActive: { backgroundColor: Colors.primary },
  toggleBtnText: { fontSize: 10, fontWeight: '700', color: Colors.textMuted },
  map3DScroll: { flex: 1 },
  map3DViewport: { flexGrow: 1, minHeight: 360, alignItems: 'center', justifyContent: 'center' },
  basement3DContainer: { alignItems: 'center', justifyContent: 'center', width: '100%', minHeight: 360, paddingHorizontal: Spacing.lg, paddingVertical: Spacing.xl },
  map3DInteractiveArea: { width: '100%', minHeight: 330, gap: Spacing.sm },
  map3DToolbar: { minHeight: 42, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: Spacing.sm, paddingHorizontal: 4 },
  map3DControls: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  map3DControlButton: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center', borderRadius: Radius.md, backgroundColor: Colors.card, borderWidth: 1, borderColor: Colors.border, shadowColor: '#020617', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.18, shadowRadius: 5, elevation: 4 },
  map3DGestureHint: { flexShrink: 1, flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 8, paddingVertical: 5, borderRadius: Radius.full, backgroundColor: 'rgba(15,23,42,0.78)' },
  map3DGestureHintText: { color: '#cbd5e1', fontSize: 10, fontWeight: '700' },
  map3DCanvasViewport: { width: '100%', minHeight: 282, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  basementColumn: { position: 'absolute', width: 12, height: 32, backgroundColor: '#334155', borderLeftWidth: 3, borderLeftColor: '#fbbf24', borderRightWidth: 3, borderRightColor: '#fbbf24', borderRadius: 2, zIndex: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 4 },
  basementLanesRow: { flexDirection: 'row', alignItems: 'center', gap: 14, zIndex: 2 },
  isometricCanvas: { width: '100%', maxWidth: 344, minHeight: 282, padding: 20, paddingVertical: 24, position: 'relative', backgroundColor: '#101a2d', borderRadius: Radius.xl, borderWidth: 1, borderColor: 'rgba(148, 163, 184, 0.24)', shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.35, shadowRadius: 16, elevation: 8 },
  deckGlow: { position: 'absolute', top: 18, left: 18, right: 18, bottom: 18, borderRadius: Radius.lg, borderWidth: 1, borderColor: 'rgba(56, 189, 248, 0.10)' },
  deckTopEdge: { position: 'absolute', top: 8, left: 24, right: 24, height: 3, borderRadius: Radius.full, backgroundColor: 'rgba(148, 163, 184, 0.28)' },
  deckBottomEdge: { position: 'absolute', bottom: 8, left: 24, right: 24, height: 5, borderRadius: Radius.full, backgroundColor: '#070c16' },
  parkingLane3D: { flex: 1, flexDirection: 'column', gap: 14 },
  slot3DBoxContainer: { position: 'relative', width: '100%', minHeight: 53, paddingBottom: 8 },
  slot3DBoxDisabled: { opacity: 1 },
  slot3DBase: { position: 'absolute', left: 6, right: 0, bottom: 0, height: 13, borderRadius: 7, backgroundColor: '#087161', borderWidth: 1, borderColor: '#075f50' },
  slot3DBaseSelected: { backgroundColor: '#0758b8', borderColor: '#064b9c' },
  slot3DBaseDisabled: { backgroundColor: '#202c40', borderColor: '#26344b' },
  slot3DSurface: { flex: 1, minHeight: 45, alignItems: 'center', justifyContent: 'center', borderRadius: Radius.sm, borderWidth: 1.5, borderColor: 'rgba(45, 212, 191, 0.8)', backgroundColor: 'rgba(6, 78, 59, 0.82)', shadowColor: '#10b981', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 7, elevation: 3 },
  slot3DSurfaceSelected: { borderColor: '#60a5fa', backgroundColor: '#0b6fe6', shadowColor: '#0b6fe6', shadowOpacity: 0.48, shadowRadius: 10 },
  slot3DSurfaceDisabled: { borderColor: '#334155', backgroundColor: 'rgba(30, 41, 59, 0.72)', shadowOpacity: 0 },
  ...
  drivewayLine3D: { alignSelf: 'stretch', width: 46, alignItems: 'center', justifyContent: 'space-between', paddingVertical: 6, borderRadius: Radius.md, backgroundColor: 'rgba(2, 6, 23, 0.44)', borderLeftWidth: 1, borderRightWidth: 1, borderColor: 'rgba(148, 163, 184, 0.16)' },
  dashedDivider: { flex: 1, width: 2, marginVertical: 8, borderStyle: 'dashed', borderWidth: 1.5, borderColor: 'rgba(251, 191, 36, 0.72)' },
  ...
  slotCell2DSelected: { borderColor: Colors.primary, backgroundColor: 'rgba(11,111,230, 0.15)', shadowColor: Colors.primary, shadowOpacity: 0.3, shadowRadius: 6 },
  ...
  drivewayLine2D: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', marginVertical: 14, paddingVertical: 8, paddingHorizontal: 12, borderStyle: 'dashed', borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.12)', backgroundColor: 'rgba(0, 0, 0, 0.02)', borderRadius: 8 },
  ...
  dashedDivider2D: { width: 1, height: 10, backgroundColor: 'rgba(0, 0, 0, 0.1)' },
  legendRow2D: { flexDirection: 'row', justifyContent: 'center', gap: 16, paddingVertical: 12, backgroundColor: Colors.cardAlt, borderBottomWidth: 1, borderBottomColor: Colors.border },
  ...
  summaryIconBox: { width: 32, height: 32, borderRadius: Radius.md, backgroundColor: 'rgba(0,0,0,0.02)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: Colors.border },
  ...
  billingCard: { backgroundColor: 'rgba(0,0,0,0.01)', borderRadius: Radius.xl, borderWidth: 1, borderColor: Colors.border, padding: Spacing.lg, gap: Spacing.md, marginTop: Spacing.xs },
  ...
  timeTriggerCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(11,111,230,0.06)', borderRadius: Radius.xl, borderWidth: 1.5, borderColor: 'rgba(11,111,230,0.35)', paddingVertical: 14, paddingHorizontal: 16 },
  ...
  pkgSelectCardActive: { borderColor: Colors.primary, backgroundColor: 'rgba(11,111,230,0.04)' },
