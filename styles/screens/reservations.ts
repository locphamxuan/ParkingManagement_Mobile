...
export const styles = StyleSheet.create({
  ...
  buildingCardActive: { borderColor: 'rgba(14,165,233,0.5)', backgroundColor: 'rgba(14,165,233,0.08)' },
  ...
  chipActive: { backgroundColor: 'rgba(14,165,233,0.15)', borderColor: 'rgba(14,165,233,0.4)' },
  ...
  floorCardActive: { borderColor: 'rgba(14,165,233,0.5)', backgroundColor: 'rgba(14,165,233,0.08)' },
  ...
  slotCell: { width: 64, height: 52, borderRadius: Radius.md, borderWidth: 1, borderColor: 'rgba(14,165,233,0.45)', backgroundColor: 'rgba(14,165,233,0.10)', alignItems: 'center', justifyContent: 'center', gap: 2 },
  slotCellSelected: { borderColor: Colors.primary, backgroundColor: 'rgba(14,165,233,0.25)' },
  ...
  feeHintBox: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(14,165,233,0.08)', borderRadius: Radius.md, borderWidth: 1, borderColor: 'rgba(14,165,233,0.2)', padding: Spacing.sm },
  feeHintText: { fontSize: FontSize.xs, color: Colors.primary, flex: 1 },
  modalBtns: { flexDirection: 'row', gap: Spacing.sm },
  openMapBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.primary, borderRadius: Radius.lg, paddingVertical: 14, gap: 8, borderWidth: 1, borderColor: 'rgba(14, 165, 233, 0.4)', shadowColor: Colors.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 4 },
  ...
  isometricCanvas: { transform: [{ perspective: 900 }, { rotateX: '58deg' }, { rotateZ: '-38deg' }], width: 320, padding: 20, backgroundColor: 'rgba(0, 0, 0, 0.05)', borderRadius: Radius.lg, borderWidth: 1, borderColor: 'rgba(0, 0, 0, 0.05)' },
  ...
  faceTopSelected3D: { backgroundColor: 'rgba(14, 165, 233, 0.35)', borderColor: '#0ea5e9', shadowColor: '#0ea5e9', shadowOpacity: 0.4, shadowRadius: 8 },
  ...
  faceLeftSelected3D: { backgroundColor: 'rgba(14, 165, 233, 0.7)' },
  ...
  faceRightSelected3D: { backgroundColor: 'rgba(14, 165, 233, 0.5)' },
  ...
  dashedDivider: { height: '100%', width: 2, borderStyle: 'dashed', borderWidth: 1.5, borderColor: 'rgba(0, 0, 0, 0.15)' },
  ...
  slotCell2DSelected: { borderColor: Colors.primary, backgroundColor: 'rgba(14, 165, 233, 0.15)', shadowColor: Colors.primary, shadowOpacity: 0.3, shadowRadius: 6 },
  ...
  timeTriggerCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(14,165,233,0.06)', borderRadius: Radius.xl, borderWidth: 1.5, borderColor: 'rgba(14,165,233,0.35)', paddingVertical: 14, paddingHorizontal: 16 },
  ...
  pkgSelectCardActive: { borderColor: Colors.primary, backgroundColor: 'rgba(14,165,233,0.04)' },
