...
export const styles = StyleSheet.create({
  ...
  quickLinkIcon: { width: 40, height: 40, borderRadius: Radius.md, backgroundColor: 'rgba(14,165,233,0.10)', alignItems: 'center', justifyContent: 'center' },
  ...
  qrShortcutCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: Colors.card, borderRadius: Radius.xl, borderWidth: 1, borderColor: 'rgba(14,165,233,0.2)', padding: Spacing.lg },
  qrShortcutLeft: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md },
  qrShortcutIconContainer: { width: 48, height: 48, borderRadius: Radius.md, backgroundColor: 'rgba(14,165,233,0.1)', alignItems: 'center', justifyContent: 'center' },
  ...
  modalContent: { backgroundColor: Colors.card, borderRadius: Radius['xl'], borderWidth: 1, borderColor: 'rgba(14,165,233,0.3)', width: '100%', maxWidth: 340, padding: Spacing.xl, alignItems: 'center', gap: Spacing.md },
  ...
  modalInfoTag: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: Radius.sm, backgroundColor: 'rgba(14,165,233,0.1)', borderWidth: 1, borderColor: 'rgba(14,165,233,0.2)' },
  ...
  packageTag: { backgroundColor: 'rgba(14,165,233,0.12)', color: Colors.primary, fontSize: 9, fontWeight: '700', paddingHorizontal: 8, paddingVertical: 3, borderRadius: Radius.sm, textTransform: 'uppercase', letterSpacing: 0.5 },
  packageVehicleBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(0,0,0,0.02)', borderWidth: 1, borderColor: 'rgba(0,0,0,0.05)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: Radius.full },
  ...
  packagePriceRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: 'rgba(0,0,0,0.06)', paddingTop: Spacing.md, marginTop: 4 },
  ...
  bellBtn: { width: 40, height: 40, borderRadius: Radius.full, backgroundColor: 'rgba(0,0,0,0.02)', borderWidth: 1, borderColor: 'rgba(0,0,0,0.05)', justifyContent: 'center', alignItems: 'center', position: 'relative' },
  ...
  markAllReadBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, alignSelf: 'flex-end', paddingVertical: 6, paddingHorizontal: 10, borderRadius: Radius.sm, backgroundColor: 'rgba(14,165,233,0.08)', marginBottom: Spacing.sm },
